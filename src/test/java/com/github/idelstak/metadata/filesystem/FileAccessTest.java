...
public class FileAccessTest {
    ...
    static void setUp() throws IOException, URISyntaxException {
        ...
        sampleFilesUrl = FileAccessTest.class.getResource(SAMPLE_FILES_PATH + NESTED_FILES_PATH);
    }
    ...
    private static void distributeAndNestFiles() throws IOException, URISyntaxException {
        ...
        URL resourcesRoot = FileAccessTest.class.getResource(SAMPLE_FILES_PATH);
